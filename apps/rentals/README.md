...
Pushing to `main` (with changes under `apps/rentals/`) builds the app and deploys it to
GitHub Pages via `.github/workflows/deploy-rentals.yml`. One-time setup:
...
This app lives at `apps/rentals/` inside the `hobbys` monorepo — see the
